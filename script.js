...
let boutonCitation = document.querySelector("#nouveau");
...
function genererNombreEntier(max) {
    ...
    // Génère un nombre en 0 et 1 ( 0.8 par exemple ) 
    // l'élément Math.floor converti le chiffre 0.8 en chiffre entier (1)
}

boutonCitation.addEventListener("click", () => {
    do {
